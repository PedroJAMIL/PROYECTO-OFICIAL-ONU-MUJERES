...
<main class="contenedor-principal">
  <div class="contenedor">
    ...
    <form method="get" action="GestionarEncuestadoresServlet" class="busqueda-form">
          ...
          <tr>
            ...
            <td>
              <div class="dropdown-estado">
                <button class="btn-estado" data-id="${encuestador.usuario.idUsuario}" data-estado="${encuestador.usuario.idEstado != null ? encuestador.usuario.idEstado : 2}">
