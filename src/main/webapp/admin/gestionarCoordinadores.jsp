...
<main class="contenedor-principal">
    <div class="contenedor">
        <div class="contenedor-header">
            ...
            <button class="btn-agregar"><i class="fa-solid fa-plus"></i> Agregar coordinador</button>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="estado-switch">
                                    <label class="switch">
                                        <input type="checkbox" <c:if test="${coordinador.usuario.idEstado == 2}">checked</c:if>>
                                        <span class="slider"></span>
                                    </label>
                                    <span class="${coordinador.usuario.idEstado == 2 ? 'estado-activo' : 'estado-inactivo'}">
                                        ${coordinador.usuario.idEstado == 2 ? 'Activo' : 'Desactivo'}
                                    </span>
                                </div>
                            </td>
