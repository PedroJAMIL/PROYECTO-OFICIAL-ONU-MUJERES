...
@WebServlet(name = "ListarRespuestasFormularioServlet", value = "/ListarRespuestasFormularioServlet")
public class ListarRespuestasFormularioServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("coordinador/jsp/ListarRespuestasFormulario.jsp").forward(request, response);
    }
}